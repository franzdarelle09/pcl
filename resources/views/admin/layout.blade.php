...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/admin/documents/create">
          <i class="fas fa-fw fa-plus"></i>
          <span>Add Documents</span></a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="/admin/officers">
          ...
          <span>Officer List</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="/admin/officers/create">
          <i class="fas fa-fw fa-user"></i>
          <span>Add Officer</span></a>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Legislative MIS {{date('Y')}}</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
