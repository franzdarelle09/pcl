      ...
      <div class="card-body">
        <form method="POST" id="form-officers" enctype="multipart/form-data" action="/admin/officers/store">
            ...
            <div class="form-group">
              ...
              <input type="text" name="fname" class="form-control" id="fname" autocomplete="off" required>
                            
            </div>
           
            <div class="form-group">
              <label for="lname">Last Name</label>
              <input type="text" name="lname" class="form-control" id="lname" autocomplete="off" required>
            ...
            <div class="form-group">
              ...
              <br>
              <textarea name="achievements" style="width: 100%; height: 250px;"></textarea>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <button class="btn btn-primary btn-block" type="submit" id="btn-news">Add Officer</button>
              </div>
        </form>
      </div>
    </div>
