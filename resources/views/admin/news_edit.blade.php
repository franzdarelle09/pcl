      ...
      <div class="card-body">
        <form method="POST" id="form-news" enctype="multipart/form-data" action="/admin/news/store">
            ...
            <div class="form-group">
              ...
              <input type="text" name="title" class="form-control" id="title" value="{{$news->title}}" autocomplete="off" required>
            ...
            <br>
            <img src="/news/{{$news->cover_photo}}" style="height: 341px;">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <button class="btn btn-primary btn-block" type="button" id="btn-news">Update News</button>
              </div>
        </form>
      </div>
    </div>
...
<script>
  ...
  quill.root.innerHTML = "<?php echo $news->content ?>";
