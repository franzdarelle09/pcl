...
<title>Municipality Of Pagsanjan</title>
<!-- CSS Files -->
    ...
    <div class="h3-logo-row wf100">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4">
            <div class="h3-logo"> <a href="/"><img src="/images/logo.jpg" class="gov-logo" alt=""></a></div>
          </div>
          <div class="col-md-4 col-sm-4">
      ...
      <div class="rev_slider_wrapper fullwidthbanner-container">
        <div id="rev-slider2" class="rev_slider fullwidthabanner">
          <ul>
            ...
            <li data-transition="slidehorizontal"> <img src="/images/sb_luisiana.jpg"  alt="" width="1920" height="685" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
              <div class="tp-caption  tp-resizeme"
							data-x="left" data-hoffset="400" 
							data-y="top" data-voffset="175" 
							data-transform_idle="o:1;"         
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-5"> 
            <!--Mayor Msg Start-->
            <div class="city-tour gallery"> <strong> Municipal Mayor </strong> <!-- <a href="http://youtu.be/VVvgm7AhFc8" data-rel="prettyPhoto" title="City Tour"><img src="/images/playicon.png" alt=""></a> --> <img src="/images/dummy.jpg" alt=""> </div>
            <!--Mayor Msg End--> 
          </div>
          <div class="col-md-8 col-sm-7">
            <div class="Mayor-welcome">
              <h5>Welcome to Sangguniang Bayan ng Luisiana</h5>
              ...
              <h6>Nestor Rondilla</h6>
              <strong>Municipal Mayor</strong> </div>
          </div>
        </div>
      </div>
    </section>
